...
public class ChengjixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ChengjixinxiEntity chengjixinxi,
		...
		if(tableName.equals("jiaoshi")) {
			chengjixinxi.setZhigonghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		if(tableName.equals("jiaoshi")) {
            ew.eq("zhigonghao", (String)request.getSession().getAttribute("username"));
		}
     ...
     * 分段统计
     */
    @RequestMapping("/sectionStat/chengjifenshu")
    @IgnoreAuth
    public R chengjifenshuSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<ChengjixinxiEntity> ew = new EntityWrapper<ChengjixinxiEntity>();
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
        ...
        List<Map<String, Object>> result = chengjixinxiService.chengjifenshuSectionStat(params, ew);
        return R.ok().put("data", result);
    }
