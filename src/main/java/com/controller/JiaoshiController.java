...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaoshiEntity u = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("zhigonghao", username));
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
    	...
    	JiaoshiEntity u = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("zhigonghao", jiaoshi.getZhigonghao()));
		if(u!=null) {
    ...
    public R save(@RequestBody JiaoshiEntity jiaoshi, HttpServletRequest request){
        if(jiaoshiService.selectCount(new EntityWrapper<JiaoshiEntity>().eq("zhigonghao", jiaoshi.getZhigonghao()))>0) {
            return R.error("职工号已存在");
        }
    ...
    public R update(@RequestBody JiaoshiEntity jiaoshi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(jiaoshi);
        if(jiaoshiService.selectCount(new EntityWrapper<JiaoshiEntity>().ne("id", jiaoshi.getId()).eq("zhigonghao", jiaoshi.getZhigonghao()))>0) {
            return R.error("职工号已存在");
        }
