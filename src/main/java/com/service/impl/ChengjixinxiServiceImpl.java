...
public class ChengjixinxiServiceImpl extends ServiceImpl<ChengjixinxiDao, ChengjixinxiEntity> implements ChengjixinxiService {
    ...
    @Override
    public List<Map<String, Object>> chengjifenshuSectionStat(Map<String, Object> params, Wrapper<ChengjixinxiEntity> wrapper) {
        return baseMapper.chengjifenshuSectionStat(params, wrapper);
    }
